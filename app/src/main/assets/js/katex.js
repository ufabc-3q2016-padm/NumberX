...
var domTree = require("./src/domTree");

var Symbol = domTree.Symbol;
...
},{"./src/ParseError":6,"./src/Settings":8,"./src/buildTree":13,"./src/domTree":15,"./src/parseTree":22,"./src/utils":25}],2:[function(require,module,exports){
/** @flow */
...
function symbolNode(value, height, depth, italic, skew, classes, style) {
    ...
    this.style = style || {};
    this.maxFontSize = 0;
    //this.id = getSymbolId(this.value);
...
symbolNode.prototype.toMarkup = function() {
    ...
    var markup = "<span data-id=\"" + this.value + "\"";
